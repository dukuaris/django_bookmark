...
SECRET_KEY = '_s7*tf-ghs-a1s5-8i4s@=u2)ppkg8jg(ucn6x0&1pe0m7w391'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.1.17', 'localhost', '127.0.0.1'] #수
...
# USE_TZ = True
USE_TZ = False  #DB에 저장되는 시간을 UTC가 아니고 한국 시간으로 설정
